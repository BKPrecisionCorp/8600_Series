...
# Set the values
vi.write("list:level 1, 5")
vi.write("list:width 1, 0.5")
vi.write("list:level 2, 4")
vi.write("list:width 2, 0.4")
vi.write("list:level 3, 3")
vi.write("list:width 3, 0.3")
vi.write("list:level 4, 2")
vi.write("list:width 4, 0.2")
vi.write("list:level 5, 1")
vi.write("list:width 5, 0.1")
# Save to slot 3
